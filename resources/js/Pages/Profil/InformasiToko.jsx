                        ...
                        <div className="grid grid-cols-1  gap-y-4 gap-x-10 text-sm text-neutral-700">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <p className="text-neutral-900">
                                    ...
                                    ac nisl urna ullamcorper pulvinar cras. Diam
                                    sit elit iaculis in bibendum augue.
                                    Tristique lacus condimentum odio eu
                                    volutpat.
                                </p>
                            </div>
                            <div className="flex flex-col gap-1">
                ...
                {showModalEdit && (
                    <div
                        className={`fixed inset-0 flex items-center justify-center z-50 transition-opacity duration-300 ${
                            showModalEdit ? "animate-fadeIn" : "animate-fadeOut"
                        }`}
                    >
